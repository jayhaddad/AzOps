...
function Initialization {
    ...
    begin {
        try {
            ...
            Connect-AzAccount -TenantId $credentials.tenantId -ServicePrincipal -Credential $credential -SubscriptionId $credentials.subscriptionId -Environment AzureUSGovenment -WarningAction SilentlyContinue | Out-Null
